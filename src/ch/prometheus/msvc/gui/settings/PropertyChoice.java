...
public class PropertyChoice {
    public static final List<PropertyChoice> levelTypeChoices=Arrays.asList(
        new PropertyChoice("Default", "DEFAULT"),
        new PropertyChoice("Flat", "FLAT"),
        new PropertyChoice("Large Biomes", "LARGEBIOMES"));
